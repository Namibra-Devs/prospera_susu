    ...
    <nav class="navbar navbar-expand-xl topnav-base">
        ...
        <div class="collapse navbar-collapse" id="topnavBaseCollapse">
            ...
            <nav class="navbar-nav nav-pills mx-auto">
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item " href="./dashboards/crypto.html">Live</a>
                        <a class="dropdown-item " href="./dashboards/saas.html">Summary</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                <a
          ...
          <nav class="navbar-nav nav-pills">
            ...
            <div class="nav-item">
              <a class="nav-link" href="#transactionModal" data-bs-toggle="modal" data-bs-target="#transactionModal">
